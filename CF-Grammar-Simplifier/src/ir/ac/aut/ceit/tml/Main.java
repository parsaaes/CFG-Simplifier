...
//        String path = System.getProperty("user.dir") + "/" + "examples/Lambda Free/Peter Linz EXERCISES 8.txt";
...
//        FileOps.write(parser.getGrammar().getAsString(),path.substring(0,path.length()-4) + "-Simplified.txt");
